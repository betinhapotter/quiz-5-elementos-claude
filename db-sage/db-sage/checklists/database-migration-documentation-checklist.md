...
- ✅ Run full schema audit (`*audit-schema`)
...
```yaml
# squads/super-agentes/workflows/modify-schema-workflow.yaml
steps:
  - step: 1-9
    action: [validation, migration, smoke-test...]
  - step: 10  # ← DOCUMENTATION STEP
    action: update-documentation
    checklist: squads/super-agentes/checklists/database-migration-documentation-checklist.md
  - step: 11
