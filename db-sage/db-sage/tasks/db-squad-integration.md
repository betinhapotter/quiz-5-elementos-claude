...
## 🚀 NEW: Use Automated Database Loader (RECOMMENDED)

**Token Savings: 90% | Time Savings: ~86%**

```bash
# Analyze expansion pack and suggest database integration
./squads/super-agentes/scripts/database-adapters/unified-db-loader.sh --analyze-pack {pack_name}

# Generate migration for expansion pack integration
./squads/super-agentes/scripts/database-adapters/unified-db-loader.sh --generate-migration {pack_name}

# Audit data flows in expansion pack
./squads/super-agentes/scripts/database-adapters/unified-db-loader.sh --audit-flows {pack_name}

# Interactive integration wizard
./squads/super-agentes/scripts/database-adapters/unified-db-loader.sh --integrate {pack_name}

# Benefits:
#   - Automatic data flow detection
#   - Schema generation from pack requirements
#   - Migration script creation
#   - Relationship mapping
#   - 90% token savings
```

**OR continue with manual expansion pack analysis below:**
