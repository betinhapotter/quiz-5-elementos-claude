...
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh

# Analyze specific query
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh "{sql}"

# With execution statistics and buffer analysis
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh "{sql}" --analyze --buffers

# Get JSON output for parsing
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh "{sql}" --format json
