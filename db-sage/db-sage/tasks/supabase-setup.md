...
## 🚀 NEW: Use Automated Database Detection + Setup (RECOMMENDED)

**Token Savings: 83% | Time Savings: ~78%**

```bash
# Interactive Supabase setup wizard
./squads/super-agentes/scripts/database-adapters/detect-database.sh --setup-supabase

# Automated Supabase project initialization
./squads/super-agentes/scripts/database-adapters/detect-database.sh --init-supabase

# Validate Supabase configuration
./squads/super-agentes/scripts/database-adapters/detect-database.sh --validate-supabase

# Setup with best practices
./squads/super-agentes/scripts/database-adapters/detect-database.sh --setup-supabase --best-practices
