...
./squads/super-agentes/scripts/database-operations/data-loader.sh {table} {csv_file}

# Load with custom delimiter
./squads/super-agentes/scripts/database-operations/data-loader.sh {table} {csv_file} --delimiter "|"

# Load with validation rules
./squads/super-agentes/scripts/database-operations/data-loader.sh {table} {csv_file} --validate

# Dry-run mode (preview changes)
./squads/super-agentes/scripts/database-operations/data-loader.sh {table} {csv_file} --dry-run
