...
```bash
# Impersonate user and test RLS policies automatically
./squads/super-agentes/scripts/database-operations/rls-test-suite.sh {table_name} --user-id {user_id}

# Test isolation between multiple users
./squads/super-agentes/scripts/database-operations/rls-test-suite.sh {table_name} --multi-user

# Interactive RLS testing session
./squads/super-agentes/scripts/database-operations/rls-test-suite.sh --interactive --user-id {user_id}
