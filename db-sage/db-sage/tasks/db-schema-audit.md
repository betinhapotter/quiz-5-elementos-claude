...
./squads/super-agentes/scripts/database-operations/health-checker.sh --schema-audit

# Schema audit with detailed report
./squads/super-agentes/scripts/database-operations/health-checker.sh --schema-audit --detailed

# Schema audit with recommendations
./squads/super-agentes/scripts/database-operations/health-checker.sh --schema-audit --recommendations

# Quick schema audit (essential checks only)
./squads/super-agentes/scripts/database-operations/health-checker.sh --schema-audit --quick
