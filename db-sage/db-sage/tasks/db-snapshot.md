...
./squads/super-agentes/scripts/database-operations/backup-manager.sh --snapshot {label}

# Create snapshot with metadata
./squads/super-agentes/scripts/database-operations/backup-manager.sh --snapshot {label} --description "Purpose description"

# Schema-only snapshot (default, faster)
./squads/super-agentes/scripts/database-operations/backup-manager.sh --snapshot {label} --schema-only

# Full snapshot (schema + data)
./squads/super-agentes/scripts/database-operations/backup-manager.sh --snapshot {label} --full
