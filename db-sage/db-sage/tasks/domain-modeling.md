...
```bash
# Interactive domain modeling wizard
./squads/super-agentes/scripts/database-operations/schema-differ.sh --domain-wizard

# Analyze business requirements and generate schema
./squads/super-agentes/scripts/database-operations/schema-differ.sh --analyze-domain

# Compare domain model with existing schema
./squads/super-agentes/scripts/database-operations/schema-differ.sh --compare-with-domain

# Generate ER diagram from domain
