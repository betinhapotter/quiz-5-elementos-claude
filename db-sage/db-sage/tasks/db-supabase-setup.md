...
## 🚀 NEW: Use Automated Database Detection (RECOMMENDED)

**Token Savings: 83% | Time Savings: ~78%**

```bash
# Detect and configure Supabase automatically
./squads/super-agentes/scripts/database-adapters/detect-database.sh --setup

# Interactive Supabase setup wizard
./squads/super-agentes/scripts/database-adapters/detect-database.sh --interactive

# Setup with environment validation
./squads/super-agentes/scripts/database-adapters/detect-database.sh --setup --validate

# Setup with project initialization
./squads/super-agentes/scripts/database-adapters/detect-database.sh --setup --init-project
