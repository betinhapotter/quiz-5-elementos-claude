...
## 🚀 NEW: Use Automated Schema Differ (RECOMMENDED)

**Token Savings: 85% | Time Savings: ~80%**

```bash
# Compare business requirements with current schema
./squads/super-agentes/scripts/database-operations/schema-differ.sh --domain-analysis

# Generate entity-relationship diagram from requirements
./squads/super-agentes/scripts/database-operations/schema-differ.sh --generate-erd

# Model domain with interactive wizard
./squads/super-agentes/scripts/database-operations/schema-differ.sh --domain-wizard

# Compare domain model with existing schema
./squads/super-agentes/scripts/database-operations/schema-differ.sh --compare-domain

# Benefits:
#   - Guided domain discovery process
