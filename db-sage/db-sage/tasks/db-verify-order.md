...
./squads/super-agentes/scripts/database-operations/migration-safe-runner.sh {path} --verify-order

# Verify with dependency graph
./squads/super-agentes/scripts/database-operations/migration-safe-runner.sh {path} --verify-order --show-graph

# Verify and suggest reordering
./squads/super-agentes/scripts/database-operations/migration-safe-runner.sh {path} --verify-order --suggest-fixes

# Verify with detailed analysis
./squads/super-agentes/scripts/database-operations/migration-safe-runner.sh {path} --verify-order --verbose
