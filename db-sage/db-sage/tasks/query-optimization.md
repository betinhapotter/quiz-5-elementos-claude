...
```bash
# Analyze and optimize query automatically
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh "{query}" --optimize

# Find slow queries and suggest optimizations
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh --find-slow --recommendations

# Optimize with index suggestions
./squads/super-agentes/scripts/database-operations/index-manager.sh --analyze-query "{query}"

# Interactive optimization session
./squads/super-agentes/scripts/database-operations/explain-analyzer.sh --interactive
