...
./squads/super-agentes/scripts/database-operations/backup-manager.sh --restore latest

# Restore from specific snapshot
./squads/super-agentes/scripts/database-operations/backup-manager.sh --restore {snapshot_id}

# List available snapshots
./squads/super-agentes/scripts/database-operations/backup-manager.sh --list

# Restore with pre-rollback safety snapshot
./squads/super-agentes/scripts/database-operations/backup-manager.sh --restore {snapshot_id} --safe
