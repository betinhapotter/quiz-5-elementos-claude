...
./squads/super-agentes/scripts/database-operations/data-loader.sh --seed {path}

# Apply seed with validation
./squads/super-agentes/scripts/database-operations/data-loader.sh --seed {path} --validate

# Dry-run mode (preview without applying)
./squads/super-agentes/scripts/database-operations/data-loader.sh --seed {path} --dry-run

# Apply to specific environment
./squads/super-agentes/scripts/database-operations/data-loader.sh --seed {path} --env production
