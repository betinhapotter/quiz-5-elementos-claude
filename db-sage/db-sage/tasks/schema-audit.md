...
## 🚀 NEW: Use Automated Health Checker + Index Manager (RECOMMENDED)

**Token Savings: 91% | Time Savings: ~88%**

```bash
# Run comprehensive schema audit with all checks
./squads/super-agentes/scripts/database-operations/health-checker.sh --full-audit

# Schema quality audit with recommendations
./squads/super-agentes/scripts/database-operations/health-checker.sh --schema-audit --recommendations

# Performance-focused audit
./squads/super-agentes/scripts/database-operations/index-manager.sh --audit-performance

# Security-focused audit
./squads/super-agentes/scripts/database-operations/health-checker.sh --security-audit

# Benefits:
#   - Complete schema quality analysis
